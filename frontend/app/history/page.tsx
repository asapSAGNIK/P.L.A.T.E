  ...
  useEffect(() => {
    const fetchHistory = async () => {
      ...
      try {
        ...
        const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/recipes/history?limit=10`, {
          headers: { 
        ...
        if (!response.ok) {
          let errorMessage = 'Failed to fetch recipe history';
          try {
                    ...
                    <CardContent className="p-6">
                      <div className="flex justify-between items-start mb-4">
                        ...
                        <div className="flex flex-col items-end gap-2">
                          ...
                          <Link href={`/recipe/${entry.recipe_data.id}`}>
